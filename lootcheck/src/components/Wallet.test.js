...
describe('Wallet', () => {
  ...
  const wallet = shallow(<Wallet {...props} />);
   ...
   it('renders an input to deposit into or withdraw from the balance', () => {
   ...
   describe('when the user types into the wallet input', () => {
    ...
    describe('and the user wants to make a deposit', () => {
      beforeEach(() => wallet.find('.button-deposit').simulate('click'));
    ...
    describe('and the user wants to make a withdrawal', () => {
      beforeEach(() => wallet.find('.button-withdraw').simulate('click'));
      
      it('dispatch the `withdraw()` it receives from props with the local balance', () => {
